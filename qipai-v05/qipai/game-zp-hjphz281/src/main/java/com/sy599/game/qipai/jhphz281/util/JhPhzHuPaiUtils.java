...
//                    System.out.println("error wang hu");
    ...
    public static int loadMaxFanCount2(Set<JhPhzFanEnums> fans,int hongDianHei) {
        int fanCount = 1;
        for (JhPhzFanEnums fan : fans) {
            String fanName =fan.getName();
            System.err.println(" fanName "+fanName);
            if(hongDianHei==0 && (fanName.equals("DIAN_HU") ||fanName.equals("HONG_HU")
                    || fanName.equals("HEI_HU") || fanName.equals("ALL_HONG")) ){
                System.err.println("1fanName "+fanName);
                continue;
            }else{
                fanCount *= fan.getFan();
            }
