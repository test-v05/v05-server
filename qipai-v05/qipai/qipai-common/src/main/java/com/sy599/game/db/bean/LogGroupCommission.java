...
public class LogGroupCommission implements Serializable {
    ...
    private long selfCommissionCredit;//加了AA后 此值变更为 非AA牌桌抽水 2021年3月25日
    private int selfCommissionCount;
    private int selfDyjCount;
    private int selfZjsCount;
    private int selfTotalPay;

    private long winCredit;//下级当天产生的输赢比赛分
    private long AACommissionCredit;//aa牌桌抽水贡献分
    ...
    public LogGroupCommission clone() {
        ...
        log.setWinCredit(winCredit);
        log.setAACommissionCredit(AACommissionCredit);
        return log;
    }
    ...
    public long getWinCredit() {
        return winCredit;
    }

    public void setWinCredit(long winCredit) {
        this.winCredit = winCredit;
    }

    public long getAACommissionCredit() {
        return AACommissionCredit;
    }

    public void setAACommissionCredit(long AACommissionCredit) {
        this.AACommissionCredit = AACommissionCredit;
    }
}
