...
//                hu(seatMap.get(nowSeat),null,PaohzDisAction.action_hu,disCard,true);
    ...
    protected void deal() {
        ...
        List<List<PaohzCard>> list = PaohuziTool.fapai(copy, zp,0,getPlayerCount());
...
//                timeout = autoTimeOut = 1000000000;
            ...
            if (daNiaoType>0&&finishFapai == 0&&playedBureau==0) {
                for (LdfpfPlayer player : seatMap.values()) {
...
//            player.writeComMessage(WebSocketMsgType.req_code_daniao_return);
    ...
    public static final List<Integer> wanfaList = Arrays.asList(GameUtil.game_type_ldfpf);
