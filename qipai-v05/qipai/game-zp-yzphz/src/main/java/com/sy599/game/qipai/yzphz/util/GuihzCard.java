...
public enum GuihzCard {
	phz1(1, 1), phz2(2, 2), phz3(3, 3), phz4(4, 4), phz5(5, 5), phz6(6, 6), phz7(7, 7), phz8(8, 8), phz9(9, 9), phz10(10, 10), phz11(11, 1), phz12(12, 2), phz13(13, 3), phz14(14, 4), phz15(15, 5), phz16(
			...
			78, 108), phz79(79, 109), phz80(80, 110), phz81(81, 201), phz82(82, 201), phz83(83, 201), phz84(84, 201);
	private int id;
	private int val;
	
	public static List<Integer> huCardList = new ArrayList<Integer>();
...
//		}
	...
	public static GuihzCard getGuihzCard(List<GuihzCard> cards, int value) {
		for (GuihzCard card : GuihzCard.values()) {
			if (card.getVal() == value && !cards.contains(card)) {
				return card;
			}
		}
		return null;
	...
	public static GuihzCard getGuihzCard(int value) {
		for(GuihzCard card : GuihzCard.values()) {
			if(card.getVal() == value) {
				return card;
			}
		}
		return null;
	...
	public static GuihzCard getPaohzCard(int id) {
		if (id == 0) {
			return null;
		}
		return GuihzCard.valueOf(GuihzCard.class, "phz" + id);
	}
	...
	public static String toString(List<Integer> pais) {
		...
		for (Integer pai : pais) {
			sb.append(GuihzCard.toString(pai)).append(",");
		}
		sb.append("]");
		return sb.toString();
	...
	public static String toString(Integer pai) {
		GuihzCard card = GuihzCard.getPaohzCard(pai);
		if (card != null) {
