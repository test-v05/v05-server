...
public final class YzPhzCheckCardBean {
	private int seat;
	// 提
	private boolean ti;
	// 碰
	...
	private YzPhzCardResult cardResult;

	public YzPhzCardResult getCardResult() {
		return cardResult;
	}

	public void setCardResult(YzPhzCardResult cardResult) {
			...
			if (actionList.get(i) == 1) {
				switch (i) {
					...
					case 6:
						...
						break;
					case 7:
						sb.append("wangDiao").append(",");
						break;
					case 8:
						sb.append("wangChuang").append(",");
						break;
					case 9:
						sb.append("wangZha").append(",");
						break;
					default:
