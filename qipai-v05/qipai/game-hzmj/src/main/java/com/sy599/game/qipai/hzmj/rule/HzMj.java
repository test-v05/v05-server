...
public enum HzMj {
    ...
    static HzMj[] mjArray;
    public static HzMj[] fullMj = new HzMj[27];
...
//                }
    ...
    public static HzMj getMajang(int id) {
        return HzMj.valueOf(HzMj.class, "mj" + id);
    }
    ...
    public static HzMj getMajiangByVal(int val) {
