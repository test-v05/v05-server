...
PROJECT_PREFIX=xyqp
#svn项目地址
PROJECT_DIR=/d/xyqp-server/server/qipai-v003/qipai/
#包输出目录
OUT_DIR=/d/serverPackages/server

#当前目录
CUR_DIR=`pwd`
#配置文件，配置需要保留的文件
PROP_FILE="/d/xyqp-server/server/qipai-v003/qipai/src/scripts/server.properties"
