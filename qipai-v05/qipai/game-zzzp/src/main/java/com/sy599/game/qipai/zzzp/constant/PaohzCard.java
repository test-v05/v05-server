package com.sy599.game.qipai.zzzp.constant;
...
//    public static void  valToPai(List<Integer> vallist){
//		for (int i : vallist) {
//			if(i <= 10){
//				System.err.print( xiao_zi[i-1]+" ");;
//			}else{
//				System.err.print( da_zi[i%100-1]+" ");
//			}
//		}
//		System.err.println("");
//	}
//
//	public static void  outToPai(List<PaohzCard> vallist){
//		for (PaohzCard m : vallist) {
//			int i = m.getVal();
//			if(i <= 10){
//				System.err.print( xiao_zi[i-1]+" ");;
//			}else{
