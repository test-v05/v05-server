...
//    private List<Integer> outPaisAll;
...
//        }
    ...
    public void removeLastPassChi(int val,int maxplayernum){
...
//                if(maxplayernum==2 && outPaisAll.contains(val)){
//                    // 修正BUG http://192.168.1.110:8109/qipai/pdk.do?type=15&funcType=3&tableId=580904&pais=1,1,2,2,101,102,103,4,104,104,105,106,106,107,107,108,109,110,9,9,5_101,101,2,3,102,103,104,5,5,106,106,107,7,7,8,8,108,108,109,10_10,4,3,6,104,110,9,103,110
//                    // 郴州字牌过吃   A打小五，B碰,打小七，A吃小四，打大十，B吃大十(二七），打小三，B吃小六，打大四，B吃大十，打大三，A偎牌，打大六
//                    // 2人互为上下家的话 错误的移除了过吃牌大10(110)
//                    // 添加逻辑：移除过吃牌前判断 移除的牌不在主动出的牌中
//                } else{
...
//            String outPaisAllStr = StringUtil.getValue(values, i++);
//            if (!StringUtils.isBlank(outPaisAllStr)) {
//                outPaisAll = StringUtil.explodeToIntList(outPaisAllStr, "_");
//            }
        }
    }
...
//        outPaisAll.clear();
    ...
    public List<Integer> getOutPaisVal() {
        return PaohuziTool.toPhzCardVals(outPais,true);
    }
...
//        if(null!=outPaisAll ){
//            sb.append(StringUtil.implode(outPaisAll, "_")).append(",");
//        }
        return sb.toString();
    }
