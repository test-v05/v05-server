package com.sy599.game.qipai.ddz.util;
...
//        }
     ...
     * 比较反主
     */
    public static boolean compareFanzhuPai(String jiaozhuCardStr , String fzpai, DdzPlayer player){
...
//        ls.add(minboom);
     ...
     * @return
     */
    public static int getDpBeiShu(List<Integer> integers,int op_dipaijiabei) {
        if(op_dipaijiabei==0){
            return 1;
        }
        int bs = 1;
        ...
        for (int pai :  integers) {
            if (pai > 500){
                wangnum++;
            }
            p2.add(loadCardValue(pai));
        }
        Collections.sort(p2);
        if(wangnum==1){
            bs =2; return bs;
        ...
        if(loadCardValue(integers.get(0))==loadCardValue(integers.get(1))&&loadCardValue(integers.get(1))==loadCardValue(integers.get(2))){
            bs=4;//豹子
            return bs;
        }
        boolean istonghua = false;
        if(loadCardColor(integers.get(0))==loadCardColor(integers.get(1))
                && loadCardColor(integers.get(1))==loadCardColor(integers.get(2)) && wangnum==0){
            bs=3;//同花
            istonghua = true;
            //同花顺 X4
            int index = p2.get(0);
        ...
        int index = p2.get(0);
        if(isDpShunzi(p2) && !istonghua && wangnum==0){
            //不是同花顺X3
            bs = 3;
     ...
     * @return
     */
    public static boolean isDpShunzi(List<Integer> list){
        List<Integer> kA2 = new ArrayList<>(); //KA2不为顺子
        kA2.add(14);  kA2.add(13);  kA2.add(15);

        List<Integer> a23 = new ArrayList<>(); //A23为顺子
        a23.add(14);  a23.add(15);  a23.add(3);

        List<Integer> _234 = new ArrayList<>(); //_234
        _234.add(15);  _234.add(4);  _234.add(3);

        if(list.containsAll(kA2)){
            return false;
        }else if(list.containsAll(a23)|| list.containsAll(_234)){
            return  true;
        }else {
            int index = list.get(0);
            if((index+1)==list.get(1) && (index+2)==list.get(2)){
                return true;
            }
        }
        return  false;
    ...
    public static boolean canChuPai(List<Integer> cpdesk, List<Integer> myout, String deskType, String mytype) {
        boolean re = false;
        if("wboom".equals(deskType)){
            return false;
        }
        if("wboom".equals(mytype)){
            return true;
        }
        ...
        if("danz".equals(deskType)){
            ...
            if("ld".equals(mytype)){
                int deskval = getCoreCardValLianDui(cpdesk);
                int myval =  getCoreCardValLianDui(myout);
                if(myval>deskval){
                    return true;
                }
            }
        ...
        }else  if("boom".equals(deskType)){
            if("boom".equals(mytype)){
                int deskval = getCoreCardVal(cpdesk,4);
                int myval =  getCoreCardVal(myout,4);
                if(myval>deskval){
                    return true;
    ...
    public static void main(String[] args) {
        List<Integer> desk = new ArrayList<>();
        List<Integer> hand = new ArrayList<>();  List<Integer> hand2 = new ArrayList<>();
        desk.add(107); desk.add(207);desk.add(307);
        desk.add(109); desk.add(209);desk.add(309);desk.add(408);desk.add(108);desk.add(208);desk.add(110);desk.add(210);desk.add(310);desk.add(410);
        desk.add(111); desk.add(211);

//        desk.add(107); desk.add(207);desk.add(307);
//        desk.add(109); desk.add(209);desk.add(309);
//        desk.add(408);desk.add(108);desk.add(208);
//        desk.add(111);desk.add(212);desk.add(313);desk.add(414);
//        desk.add(115); desk.add(211);

        hand.add(110); hand.add(210);hand.add(210);
        hand.add(111); hand.add(211);hand.add(311);
        hand.add(312);hand.add(112); hand.add(212); hand.add(213);hand.add(113); hand.add(313); hand.add(413);
        hand.add(105); hand.add(105);
        String deskType = DdzSfNew.getCpType2(DdzSfNew.intCardToStringCard(desk),1,1,1);
         String mytype = DdzSfNew.getCpType2(DdzSfNew.intCardToStringCard(hand),1,1,1);
        System.out.println("deskType:"+deskType);
//         System.out.println("mytype:"+mytype);
//       System.out.println(canChuPai(desk,hand,deskType,mytype));
    ...
    private static int getCoreCardValFeiJi(List<Integer> cards ){
        ...
        return valList2.get(0);
    }

    private static int getCoreCardValLianDui(List<Integer> cards ){
        List<Integer> valList = new ArrayList<>();
        for (int p:cards) {
            valList.add(loadCardValue(p));
        }
