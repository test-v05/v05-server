...
public class LdsPhzCardTypeHuxi {
	private int action;
	private List<Integer> cardIds;
	private int hux;

	public LdsPhzCardTypeHuxi(int action, List<Integer> cardIds, int hux) {
		this.action = action;
		this.cardIds = cardIds;
		this.hux = hux;
	}

	public LdsPhzCardTypeHuxi() {
	}
	...
	public Builder buildMsg(boolean hideCards) {
		...
		if (hideCards) {
			msg.addAllCards(LdsPhzConstants.toPhzCardZeroIds(cardIds));
		} else {
