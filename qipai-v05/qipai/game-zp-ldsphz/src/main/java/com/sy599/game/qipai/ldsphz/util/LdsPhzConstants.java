...
public final class LdsPhzConstants {
    /** 胡 **/
    ...
    static {
        ...
        actionNameMap.put(action_wangdiao, "wangDiao");
        actionNameMap.put(action_wangchuang, "wangChuang");
        actionNameMap.put(action_wangzha, "wangZha");
    }
